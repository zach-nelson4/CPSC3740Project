...
(define (startEval2 list1 list2 list3)
  ...
  (cond
    ...
    [(and (pair? list1) (equal? (car list1) 'if))
          (MyIf(startEval2 (cadr list1) list2 list3)(startEval2 (caddr list1) list2 list3) (startEval2 (cadddr list1) list2 list3))]
    ...
    [(and (pair? list3) (and (pair? list1) (and (pair? (car list2)) (and (pair? (cdr(car list2)))
      (and (pair? (cdr list1)) (and (equal? (car(cdr(car list2))) "UNDEF")
